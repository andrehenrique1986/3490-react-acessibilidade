...
const CampoDigitacao = forwardRef<HTMLInputElement, CampoDigitacaoProps>(({ legenda, id, erro, ...rest }, ref) => {
    ...
    return (
      <label htmlFor={id} className="campo__texto--legenda">
        {legenda}
        <input className="campo__texto" id={id} ref={ref} {...rest} aria-describedby={erroId}/>
